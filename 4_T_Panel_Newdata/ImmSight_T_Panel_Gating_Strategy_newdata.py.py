...
"""
Title:ImmSight_T_Panel_Gating_Strategy_newdata.py
Date: 2025-11-18
Author: Wenxia Ren
Description:
This program is used for gating the T cell panel in ImmSight project for data generated after 05/30/2025
Note:
...
5) The event number and MFT for each population are calculated and saved in ImmSight_T_Cell_11172025.txt and ImmSight_B_Cell_MFI_11172025.txt
"""
...
corrections_yaml_file ="/home/wenxiaren/T_panel_new_batch/old/T_correction.yaml"
...
# ********************************************************************************************************************************************************************************************************
    ...
    CD3neg_HLADRpos = ag.gateThreshold(fcs, xCol=HLADR, yCol="FSC 488/10-H", name="CD3neg_HLADRpos", thresh=400, parentGate=CD3neg,
...
# ********************************************************************************************************************************************************************************************************
    ...
    if ID in corrections_dict_raw['CCR10_sigma 1.5']:
        ...
        CCR10_sigma = 2.0
    elif ID in corrections_dict_raw['CCR10_sigma 0.8']:
        CCR10_sigma = 0.8
    elif ID in corrections_dict_raw['CCR10_sigma 1.0']:
        CCR10_sigma = 1.0
    elif ID in corrections_dict_raw['CCR10_sigma 1.8']:
        CCR10_sigma = 1.8
    else:
        CCR10_sigma = 2.5
...
# ******************************************************************************************************************************************************************************************************** 
    ...
    mean,median,sigma,max = ag.axisStats(fcs(), xCol=CCR10_A,vI=temphiCCR10(),scale="bilog", T=500)
    if ID in corrections_dict_raw['Th_17_22_CCR10_sigma 1']:
        Th_17_22_CCR10_sigma = 1
    else:
...
if __name__ == '__main__':
    ...
    # Load files 
    path = "/home/wenxiaren/T_panel_new_batch/new_data_filepath.csv"
    all_files = []
    ...
    Gen_exp=ag.AGExperiment(random_inputfile, filters=["T panel"], mask=["Comp"] , compList=[], 
        experiment_name="ImmSight_T_Cell_11052025", flourochrome_area_filter=True, QC=True, QCbins=128)
    Gen_exp.apply(gateGeneralDataSet,n_processes=15)
    output = "/home/wenxiaren/cbio4/projects/Wenxia/ImmSight_T_Panel_newdata/ImmSight_T_Cell_11172025.txt"
    output_MFI  = "/home/wenxiaren/cbio4/projects/Wenxia/ImmSight_T_Panel_newdata/ImmSight_B_Cell_MFI_11172025.txt"
