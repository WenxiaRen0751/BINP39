...
"""
Title:ImmSight_B_Panel_Gating_Strategy_newdata.py
Date: 2025-11-10
Author: Wenxia Ren
Description:
This program is used for gating the B cell panel in ImmSight project for data generated after 05/30/2025
Note:
...
3) The event number and MFT for each population are calculated and saved in ImmSight_B_Cell_11252025.txt and ImmSight_B_Cell_MFI_11252025.txt
4) This scripts is inherited and modified from ImmSight_B_Panel_Gating_Strategy.py which are used for gating data generated before 05/30/2025
"""
...
# Function to gate plasmablasts with optimal threshold
...
def gateGeneralDataSet(fcs, *args, **kwargs):
    ...
    if sample_ids in corrections_dict_raw['NK Gating']['CUSTOM_y1=1000']:
        ...
        ylim_1 = 800
    elif sample_ids in corrections_dict_raw['NK Gating']['CUSTOM_y1=600']:
        ylim_1 = 600
    ...
    if sample_ids in corrections_dict_raw['NK Gating']['CUSTOM_x=1000']:
        ...
        hixlim = 800
    elif sample_ids in corrections_dict_raw['NK Gating']['CUSTOM_x=200']:
        hixlim = 200
    ...
    if sample_ids in corrections_dict_raw['CD56-CD16+NK']['xThresh2=3000']:
        ...
        xThresh2 = 25000
    elif sample_ids in corrections_dict_raw['CD56-CD16+NK']['xThresh2=300']:
        xThresh2 = 300
    ...
    elif sample_ids in corrections_dict_raw['CD56-CD16+NK']['Thresh2=200']:
        CD56negCD16posNK = ag.gateCorner(fcs, "CD56negCD16posNK", parentGate=CD14neg, xCol=CD16, yCol=CD56, xThresh=200, yThresh=ylim_1, yOrientation='lower', xOrientation='upper', scale='bilog',T=100, filePlot=None)
    elif sample_ids in corrections_dict_raw['CD56-CD16+NK']['Thresh2=300']:
        CD56negCD16posNK = ag.gateCorner(fcs, "CD56negCD16posNK", parentGate=CD14neg, xCol=CD16, yCol=CD56, xThresh=300, yThresh=ylim_1, yOrientation='lower', xOrientation='upper', scale='bilog',T=100, filePlot=None)
    else:
    ...
    if sample_ids in corrections_dict_raw['NK Gating']['y2-20%']:
        ...
        ylim_2 =  ylim_2 *0.9
    elif sample_ids in corrections_dict_raw['NK Gating']['y2=0.1']:
        ylim_2 =  ylim_2 *0.1
    elif sample_ids in corrections_dict_raw['NK Gating']['y2=0.15']:
        ylim_2 =  ylim_2 *0.15
    elif sample_ids in corrections_dict_raw['NK Gating']['y2=0.2']:
        ylim_2 =  ylim_2 *0.2
    elif sample_ids in corrections_dict_raw['NK Gating']['y2=0.6']:
        ylim_2 =  ylim_2 *0.6
    elif sample_ids in corrections_dict_raw['NK Gating']['y2=0.7']:
        ylim_2 =  ylim_2 *0.7
        ...
        ylim_2 = 3000
    elif sample_ids in corrections_dict_raw['NK Gating']['CUSTOM_y2=600']:
        ylim_2 = 600
    else:
        ylim_2 = ylim_2
    ...
    elif sample_ids in corrections_dict_raw['Second DC Gating']['HLADR_1000']:
        HLADRpos=ag.gateThreshold(fcs, "HLADRpos", xCol=HLADR, yCol=CD56, parentGate=doubleNegNK, thresh=1000, population='upper', scale='bilog', T=500,filePlot=fileName)
    elif sample_ids in corrections_dict_raw['Second DC Gating']['HLADR_300']:
        HLADRpos=ag.gateThreshold(fcs, "HLADRpos", xCol=HLADR, yCol=CD56, parentGate=doubleNegNK, thresh=300, population='upper', scale='bilog', T=500,filePlot=fileName)
    else:
...
if __name__ == '__main__':
    ...
    path = "/home/wenxiaren/aligater/Scripts/ImmSight_B/Scripts/new_data_path.csv"   
    all_files = []
    ...
    Gen_exp=ag.AGExperiment(random_inputfile, filters=["B panel"], mask=["Comp"] , compList=[], 
        experiment_name="ImmSight_B_Cell_11252025", flourochrome_area_filter=True, QC=True, QCbins=128)
    Gen_exp.apply(gateGeneralDataSet,n_processes=15)
    output = "/home/wenxiaren/cbio4/projects/Wenxia/ImmSight_B_panel_newdata/ImmSight_B_Cell_11252025.txt"
    output_MFI  = "/home/wenxiaren/cbio4/projects/Wenxia/ImmSight_B_panel_newdata/ImmSight_B_Cell_MFI_11252025.txt"
