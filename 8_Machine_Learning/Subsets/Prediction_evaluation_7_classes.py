...
Date: 2025-10-11
Description:
This script is to evaluate the performance of the trained MPL model for 7 subsets classification from singlets
...
def evaluate(model, pt_files, leaf_to_name, num_classes,
    ...
    with torch.no_grad():
        ...
        for pt_file in pt_files:
            ...
            'BV605 CD19-A_v2', 'Alexa 700 CD3-A_v2', 'APC-H7 CD45-A_v2', 'APC CD16-A_v2']
    ...
    leaf_probs_all = np.concatenate(leaf_probs_all, axis=0)  # [N_total, num_classes]
...
if __name__ == "__main__":
    ...
    # Load the model foir classes
    model_path = "/home/wenxia/Part_3_ML/training/mlp_7classes.pt"  
