...
# loading the model for 6 classes
model_path = "/home/wenxiaren/Part_3_ML/Prediction_Evaluation/Multiple_Classes_CD3neg_monocytes/mlp_6classes_2.pt"  
...
with open(test_data_path, "r") as f:
    for i in f:
        ...
        #################################################### gating PBMCs and Singlets based on Aligater #########################################################
        ...
        # transformatting the data from numpy to torch
        ...
        # class mapping
        class_dict = {"CD19pos":0,"CM":1,"non_CM":2,"CD14neg":3,"CD45posCD3pos":4,"rest_of_singlets":5}
        indices_dict = {}
        ...
        # plotting the CD45+CD3-
        CD45posCD3neg_indices =  list(np.concatenate([indices_dict["CD19pos"], indices_dict["CM"],indices_dict["CD14neg"],indices_dict["non_CM"]]))
        ...
        CD19neg_indices =  list(np.concatenate([indices_dict["CM"],indices_dict["CD14neg"],indices_dict["non_CM"]]))
        # plotting the CD19pos
