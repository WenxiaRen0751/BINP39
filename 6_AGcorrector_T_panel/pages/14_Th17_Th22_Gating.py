...
#!/usr/bin/env python3
"""
Title:14_Th17_Th22_Gating.py
Date: 2025-05-27
Author: Wenxia Ren
Description: 
The gating strategy for Th17 and Th22 cells 
"""
...
def gateGeneralDataSet(fcs,Th_17_22_CCR10_sigma,Th17_22_sigma_1,Th17_22_sigma_2):
    SSC = "SSC 488/10-A"
    FSC = "FSC 488/10-A"
    FSC_H = "FSC 488/10-H"
    CD39 = "BB515 CD39-A"
    ...
    fileName1="/home/wenxiaren/AGcorrector_T_panel/tmp/"+Image_ID_prefix+"-Th22_Th17_subpopulation.png"
    NS_1,NS_2,Th22,Th17 = ag.quadGate(fcs=fcs, names=[' NS_1','NS_2','Th22','Th17'], xCol=CCR10_A, yCol=CXCR3, xThresh=CCR10_lim, yThresh=CXCR3_lim, parentGate=Th22_Th17, scale='bilog', T=500, filePlot=fileName1)
...
with st.sidebar:  
    ...
    Th_17_22_CCR10_sigma = st.number_input("Th_17_22_CCR10_sigma", min_value=-10.0, max_value=10.0,step=1.,format="%.1f")
    Th17_22_sigma_1= st.number_input("Th17_22_sigma_1", min_value=-10.0, max_value=10.0,step=1.,format="%.1f")
    Th17_22_sigma_2= st.number_input("Th17_22_sigma_2", min_value=-10.0, max_value=10.0,step=1.,format="%.1f")
    st.markdown("---")
    # Parameter selection for Update/Confirm
    st.markdown("### Select Parameters to Apply")
    parameter_options = [
        "Th_17_22_CCR10_sigma",
        "Th17_22_sigma_1",
        "Th17_22_sigma_2"
       ]
    ...
    unsafe_allow_html=True
            ...
            if Update:
                if not selected_parameters:
                    ...
                    sigma_converted, fileName1 = gateGeneralDataSet(
                        fcs, 
                        final_params['Th_17_22_CCR10_sigma'],
                        final_params['Th17_22_sigma_1'],
                        final_params['Th17_22_sigma_2']
                    )
                    st.write(f"Th17_22: {sigma_converted}") 
                    cols = st.columns(4)
                    with cols[0]:
            ...
            if Confirm:
                if not selected_parameters:
                    ...
                    para_dict = {}
                    if "Th_17_22_CCR10_sigma" in selected_parameters:
                        para_dict[f"Th_17_22_CCR10_sigma {Th_17_22_CCR10_sigma}"] = Th_17_22_CCR10_sigma
                    if "Th17_22_sigma_1" in selected_parameters:
                        para_dict[f"Th17_22_sigma_1 {Th17_22_sigma_1}"] = Th17_22_sigma_1
                    if "Th17_22_sigma_2" in selected_parameters:
                        para_dict[f"Th17_22_sigma_2 {Th17_22_sigma_2}"] = Th17_22_sigma_2

                    YAML_PATH = "/home/wenxiaren/AGcorrector_T_panel/tmp/Th_17_22_correction.yaml"
