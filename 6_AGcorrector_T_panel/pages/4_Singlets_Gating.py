...
Author: Wenxia Ren
Description: 
This page is used to adjust the singlet gating parameters for T cell panel.
1) The singlet gating use the function ag.gatePC with the following three parameters to be adjusted: adjustAngle, widthScale, heightScale.
2) The output image is saved in the folder: /home/wenxiaren/AGcorrector_T_panel/tmp/
3) The adjusted parameters for each sample are saved in the YAML file: /home/wenxiaren/AGcorrector_T_panel/tmp/Singlets_correction.yaml
"""
...
# set the path for the corrections YAML file
...
def gateGeneralDataSet(fcs, adjustAngle_1,widthScale_1,heightScale_1):
    ...
    ##################################################################### the main part: Singlet gating #####################################################################
    #Singlet gating
    fileName_1="/home/wenxiaren/AGcorrector_T_panel/tmp"+Image_ID_prefix+"-singlets.png"
...
for col in row2:
    ...
    unsafe_allow_html=True
            ...
            if Confirm:
                ...
                YAML_PATH = "/home/wenxiaren/AGcorrector_T_panel/tmp/Singlets_correction.yaml"
