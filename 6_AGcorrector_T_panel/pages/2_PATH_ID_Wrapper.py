...
Author: Wenxia Ren
Description:
This program is used to generate the absolute path for the raw .fcs files and the image IDs for the ImmSight T panel data.
...
with content_container:
    ...
    with col2:
        ...
        if FCS_PATH is not None:
            output_path_1 = "/home/wenxiaren/AGcorrector_T_panel/tmp/fsc_path.txt"
            output_path_2 = "/home/wenxiaren/AGcorrector_T_panel/tmp/Image_ID_Prefix.txt"
