...
Author: Wenxia Ren
Description:
This program is used for customed gating of PBMC population in the T cell panel in ImmSight project.
...
# From the past experience, in the PBMC gating strategies, these parameters may significantly affect the final gating result.
def PBMC_Gating(fcs, direction, xboundaries,no_clutter_thresh, cut_off_xlim, cut_off_ylim):
    ...
    fileName_2 ="/home/wenxiaren/AGcorrector_T_panel/tmp"+date+"-"+plate+"-"+sampleName+"- xlim.png"
    ...
    fileName_3 ="/home/wenxiaren/AGcorrector_T_panel/tmp"+date+"-"+plate+"-"+sampleName+"- ylim.png"
    ...
    fileName_4="/home/wenxiaren/AGcorrector_T_panel/tmp"+date+"-"+plate+"-"+sampleName+"- PBMC.png"
    ...
    fileName_1 ="/home/wenxiaren/AGcorrector_T_panel/tmp"+date+"-"+plate+"-"+sampleName+"- PBMC_back.png"
...
with st.sidebar:
    ...
    cut_off_xlim = st.number_input("cut_off_xlim", min_value=0, max_value=250000, value=65000, step=500)
    cut_off_ylim = st.number_input("cut_off_ylim", min_value=0, max_value=250000, value=115000, step=500)
...
for col in row1:
    ...
    with content_container:
        ...
        with col2:
            ...
            # update the ID file
            st.markdown("""**Please Upload the sample ID file**""")
            Smaple_IDs = st.file_uploader("Upload ID", type="txt")
            # update the PATH file
            st.markdown("""**Please Upload the .fcs path file**""")
...
# For row2, there are two sub-rows, the first one the original image from the input, thr second one is the updated image after adjusting the parameters.
row2 = st.columns(1)
Images = []
for col in row2:
    ...
    unsafe_allow_html=True
            ...
            if Confirm:
                ...
                YAML_PATH = "/home/wenxiaren/AGcorrector_T_panel/tmp/PBMC_correction.yaml"
                ...
                # pdate other individual parameters
