...
#!/usr/bin/env python3
"""
Title:8_CXCR5+Tfh_Gating.py
Date: 2025-05-27
Author: Wenxia Ren
Description:
Tfh Gating with parameter adjustment and image update functionality. This script implements a gating strategy for CXCR5+T T follicular helper (Tfh) cell
"""
...
def gateGeneralDataSet(fcs, in_1,in_2,in_3,in_4):
    ...
    if ylim < 200:
        ylim=200
    ############################################# the main part CXCR5+Tfh_Gating ######################################################
    ...
    unsafe_allow_html=True
            ...
            if Confirm:
                if not selected_parameters:
                    ...
                    YAML_PATH = "/home/wenxiaren/AGcorrector_T_panel/tmp/CXCR5_Tfh_correction.yaml"
